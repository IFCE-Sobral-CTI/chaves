            ...
            <AuthenticatedLayout titleChildren={'Gerenciamento de Regras'} breadcrumbs={[{ label: 'Regras', url: route('rules.index') }]}>
                <div className="flex md:flex-row gap-2 md:gap-4">
                    {can.create && <Panel className={'inline-flex'}>
                        <Link href={route('rules.create')} className="inline-flex gap-2 items-center justify-between py-2 px-3 rounded-md transition font-light border border-transparent focus:ring-2 bg-blue-500 text-white hover:bg-blue-600 focus:ring-sky-300">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="h-5 w-5" viewBox="0 0 16 16">
